...
<!-- Multistep Form -->
  ...
  <div id="first">
    ...
    <div class="error">
      ...
      $sql = "SELECT * FROM senior_application WHERE user_id=".$id;
      ...
      $sql = "SELECT * FROM senior_application_detail WHERE user_id=".$id;
      $result = mysqli_query($conn, $sql);
      ...
      $sql = "SELECT * FROM senior_upload_requirements WHERE user_id=".$id;
      $result = mysqli_query($conn, $sql);
      $row = mysqli_fetch_assoc($result);
 ...
 <div class="form-inline">
  ...
  <div class="form-inline"><br>
      <select class="form-control" name="occupation[]">
       ...
       <input type="text" class="form-control"  name="occupation1"  placeholder="Others pls. specify"pattern="^[a-zA-Z, ]+$"  oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)" value="<?php ?>"><br>
       </div><br>
       <div class="form-inline"><br>
       ...
       <input type="text" class="form-control"  name="SOURCE1"  placeholder="Others pls. specify" pattern="^[a-zA-Z, ]+$"  oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)"value="<?php ?>"><br>
       <br><br>
