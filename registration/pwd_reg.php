...
<strong>Control Number:<a style="color:red;"> (Remember this control number)</a></strong><br><br>
  ...
  <a style="color:red">*</a><input type="text" class="form-control"  name="Pwd_Num" id ="Pwd_Num" pattern="^[0-9-]+$"  oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)"placeholder="PWD Number" value="<?php echo $Pwd_Num;?>"><br><br>
