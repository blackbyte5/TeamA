  ...
  <div id="first">
    ...
    <div class="error">
      ...
      $Comm_Serv = '';
        ...
        $sqlpwd = "SELECT * FROM pwd_applications";
        $resultpwd = mysqli_query($conn, $sqlpwd);
        mysqli_num_rows($resultpwd);
...
<strong>Control Number:<a style="color:red;"> (Remember this control number)</a></strong><br><br>
  ...
  <a style="color:red">*</a><input type="text" class="form-control"  name="Pwd_Num" id ="Pwd_Num" pattern="^[0-9-]+$"  oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)"placeholder="PWD Number" value="<?php echo $Pwd_Num;?>" required><br><br>
  <a style="color:red">*</a><input type="text" class="form-control"  name="lname" placeholder="Last Name" pattern="^[a-zA-Z ]+$" oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)" pattern="^[a-zA-Z ]+$" oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)"value="<?php echo $lname;?>">
  <a style="color:red">*</a><input type="text" class="form-control"  name="fname" placeholder="First Name" pattern="^[a-zA-Z ]+$" oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)" pattern="^[a-zA-Z ]+$" oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)"value="<?php echo $fname;?>">
  <input type="text" class="form-control"  name="mname" placeholder="Middle Name" pattern="^[a-zA-Z ]+$" oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)" pattern="^[a-zA-Z ]+$" oninput="if (!this.checkValidity()) this.value = this.value.slice(0, -1)"value="<?php echo $mname;?>">
  </div>
  ...
  <input class="btn btn-primary" name="next" id = "next" type="button" value="Next">
</div>
