...
<!-- Multistep Form -->
  ...
  <div id="first">
    ...
    <div class="error">
      ...
      $sql = "SELECT * FROM disapproved_senior_app_detail WHERE ControlNumber=".$id;
      $result = mysqli_query($conn, $sql);
...
//------------------------------------------------Update-----------------------------------
  ...
  $allowTypes = array('pdf');
    ...
    if(move_uploaded_file($_FILES['pdf_file']['tmp_name'], $targetFilePath))
    {
      ...
      $sql1 = "UPDATE disapproved_senior_app_detail SET user_id='$id', ComelicReg='$Com_Reg', HighestEducationalAttainment='$hea',Living_Residing='$Living', Occupation='$Occupation', SourceIncome='$Source', MonthlyIncome='$MONTHLY',
